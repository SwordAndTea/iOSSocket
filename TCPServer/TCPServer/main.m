...
//        CFRelease(sourceRef);
//
//        printf("Socket listing on port %d\n",PORT);
//        CFRunLoopRun();
        TCPSocketServerManager *manager=[[TCPSocketServerManager alloc]initWithPORT:6969];
        NSLog(@"%@",[manager getIpAddresses]);
    }
    return 0;
}
